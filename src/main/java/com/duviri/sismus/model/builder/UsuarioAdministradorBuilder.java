...
import com.duviri.sismus.model.UsuarioAdministrador;

public class UsuarioAdministradorBuilder implements UsuarioBuilder {
    private int id;
    private String nome;
    ...
    public Usuario build() {
        return new UsuarioAdministrador(id, nome, email, endereco, telefone, senha);
    }
}
